    ...
    <main className="h-screen">
      <div className="flex flex-col items-center">
        ...
        <div className="px-2 mt-2 pb-2 w-full max-w-[500px]">
          <Cupom porcent="10" name="Chopp To a Tôa" description="esse é um cupom comum para que os consumidores possam estar aproveitando da melhor forma as igrarias dos estabelecimentos" />
